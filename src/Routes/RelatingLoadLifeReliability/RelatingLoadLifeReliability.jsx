...
// import TextRelatingLoadLifeReliability from "../../Components/TextRelatingLoadLifeReliability/TextRelatingLoadLifeReliability";
// import InputForm from "../../Components/InputForm/InputForm";

function RelatingLoadLifeReliability() {
  // const formData = {
  //   legend: {
  ...
  return (
    <Fragment>
      <h2>Relating Load, Life and Reliability</h2>
      {/* <InputForm formData={formData} /> */}
      {/* <TextRelatingLoadLifeReliability /> */}
    </Fragment>
  );
}

export default RelatingLoadLifeReliability;
